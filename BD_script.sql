...
CREATE TABLE IF NOT EXISTS `it_project`.`itinerary` (
  `id` BINARY(16) NOT NULL,
  `name` ENUM('Frontend', 'Java', 'Net', 'Android') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `it_project`.`student` (
  ...
  `interview_result` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `it_project`.`current_delivery_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `it_project`.`current_delivery_state` (
  `student` BINARY(16) NOT NULL,
  `exercise` BINARY(16) NOT NULL,
  `state` ENUM('For Revision', 'Corrected', 'With Errors') NOT NULL,
  `date` DATE NOT NULL,
  PRIMARY KEY (`student`, `date`, `exercise`, `state`),
  INDEX `FK_exercise_current_delivery_state_idx` (`exercise` ASC) ,
  CONSTRAINT `FK_student_current_delivery_state`
    FOREIGN KEY (`student`)
    REFERENCES `it_project`.`student` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_exercise_current_delivery_state`
...
-- -----------------------------------------------------
-- Table `it_project`.`historic_delivery_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `it_project`.`historic_delivery_state` (
  `student` BINARY(16) NOT NULL,
  `exercise` BINARY(16) NOT NULL,
  `state` ENUM('For Revision', 'Corrected', 'With Errors') NOT NULL,
  `date` DATE NOT NULL,
  PRIMARY KEY (`student`, `state`, `date`, `exercise`),
  INDEX `FK_exercise_historic_delivery_state_idx` (`exercise` ASC) ,
  CONSTRAINT `FK_student_historic_delivery_state`
    FOREIGN KEY (`student`)
    REFERENCES `it_project`.`student` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_exercise_historic_delivery_state`
    FOREIGN KEY (`exercise`)
    REFERENCES `it_project`.`exercise` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
