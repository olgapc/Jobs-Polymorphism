...
public class CurrentDeliveryStatePK implements Serializable
{
    ...
    public CurrentDeliveryStatePK()
    {
    }

    public CurrentDeliveryStatePK(byte[] student, byte[] exercise, States state, Date date)
    {
    ...
    public boolean equals(Object object)
    {
        ...
        if (!(object instanceof CurrentDeliveryStatePK))
        {
            return false;
        }
        CurrentDeliveryStatePK other = (CurrentDeliveryStatePK) object;
    ...
    {
        return "containerjpa.CurrentDeliveryStatePK[ student=" + student + ", exercise=" + exercise + ", state=" + state + ", date=" + date + " ]";
    }
